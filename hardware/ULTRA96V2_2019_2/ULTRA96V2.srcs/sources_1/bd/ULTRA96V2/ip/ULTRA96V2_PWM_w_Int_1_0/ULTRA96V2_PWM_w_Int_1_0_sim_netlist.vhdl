...
-- Date        : Thu Apr  2 11:16:50 2020
-- Host        : plnx20192 running 64-bit Ubuntu 18.04.1 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/training/projects/test_u96v2/hdl/Projects/ultra96v2_oob/ULTRA96V2_2019_2/ULTRA96V2.srcs/sources_1/bd/ULTRA96V2/ip/ULTRA96V2_PWM_w_Int_1_0/ULTRA96V2_PWM_w_Int_1_0_sim_netlist.vhdl
...
entity ULTRA96V2_PWM_w_Int_1_0_PWM_Controller_Int is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ULTRA96V2_PWM_w_Int_1_0_PWM_w_Int_S00_AXI is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ULTRA96V2_PWM_w_Int_1_0_PWM_w_Int is
  port (
    s00_axi_awready : out STD_LOGIC;
    s00_axi_wready : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  Q(31 downto 0) <= \^q\(31 downto 0);
PWM_Controller_Int_Inst: entity work.ULTRA96V2_PWM_w_Int_1_0_PWM_Controller_Int
     port map (
...
PWM_w_Int_S00_AXI_inst: entity work.ULTRA96V2_PWM_w_Int_1_0_PWM_w_Int_S00_AXI
     port map (
      DI(7) => PWM_w_Int_S00_AXI_inst_n_6,
      DI(6) => PWM_w_Int_S00_AXI_inst_n_7,
      DI(5) => PWM_w_Int_S00_AXI_inst_n_8,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ULTRA96V2_PWM_w_Int_1_0 is
  port (
    PWM_out : out STD_LOGIC_VECTOR ( 0 to 0 );
    Interrupt_Out : out STD_LOGIC;
    PWM_Counter : out STD_LOGIC_VECTOR ( 19 downto 0 );
  ...
  attribute ip_definition_source of ULTRA96V2_PWM_w_Int_1_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of ULTRA96V2_PWM_w_Int_1_0 : entity is "PWM_w_Int,Vivado 2019.2.1";
end ULTRA96V2_PWM_w_Int_1_0;

architecture STRUCTURE of ULTRA96V2_PWM_w_Int_1_0 is
...
U0: entity work.ULTRA96V2_PWM_w_Int_1_0_PWM_w_Int
     port map (
      Interrupt_Out => Interrupt_Out,
      PWM_Counter(19 downto 0) => PWM_Counter(19 downto 0),
      PWM_out(0) => PWM_out(0),
